...
while (True):
  ...
  ## check for case 4: the learner has typed Kolkata
  elif city == "Kolkata":
    hour = hour + 5
    minutes = minutes + 30

  ## check for case 4: the learner has typed Karachi
  elif city == "Karachi":
    hour = hour + 5

  ## check for case 4: the learner has typed Cairo
  elif city == "Cairo":
    hour = hour + 2
  
  ## check for case 4: the learner has typed Shanghai
  elif city == "Shanghai":
    hour = hour + 8
